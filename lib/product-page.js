...
.pd-wa{background:#25D366;color:#fff;border:none;padding:14px 22px;border-radius:11px;font-weight:700;text-decoration:none;font-size:15px;display:inline-flex;align-items:center;gap:7px}
.pd-trust{margin-top:14px;font-size:12.5px;color:var(--grey);display:flex;gap:8px;flex-wrap:wrap;align-items:center}
.pd-trust b{color:#2b2f38}
  ...
  <div class="pd">
    ...
    <div class="pd-info">
      ...
      <div class="pd-actions">
        ...
        <a class="pd-wa" href="https://wa.me/77053541999?text=${encodeURIComponent('Здравствуйте! Интересует: ' + ttl + ' (арт. ' + p.sku + '). Подскажите цену и наличие.')}" target="_blank" rel="nofollow">✆ WhatsApp</a>
        <a class="pd-call" href="tel:${PHONE}">Позвонить</a>
      </div>
      <div class="pd-trust"><b>Гарантия производителя</b> · Доставка по Казахстану · Опт для монтажников</div>
