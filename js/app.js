...
function renderSidebar(){
  ...
  // атрибутивные фильтры — в выпадающую панель у сортировки
...
function activeFilterCount(){let n=0;['brand','type','mp','conn'].forEach(f=>n+=F[f].size);if(F.pmin!=null)n++;if(F.pmax!=null)n++;return n;}
